...
include_once("./Customizing/global/plugins/Services/Repository/RepositoryObject/LfEduSharingResource/classes/class.ilLfEduSharingResourcePlugin.php");
...
//		require_once("./Customizing/global/plugins/Services/Repository/RepositoryObject/LfEduSharingResource/lib/class.locallib.php");
//		$sh = new ilFormSectionHeaderGUI();
//		$sh->setTitle("Test: ".edusharing_get_auth_key());
//		$form->addItem($sh);
